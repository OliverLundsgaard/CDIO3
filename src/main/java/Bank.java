...
class Bank {
    ...
    public Bank() {
        //chancekort = new Chancekort[16]{
           ...
           new GratisFelt("Ryk frem til Skaterparken for at lave det perfekte grind. Hvis ingen ejer den får du den gratis\n" +
                   "ellers skal du betale leje til ejeren",Skaterparken);
           new GratisFelt("GRATIS FELT: Ryk frem til et rødt felt. Hvis ingen ejer den får du den gratis ellers\n" +
                   "skal du betale leje til ejeren",rødtfelt (spillehallen));
           new GratisFelt("GRATIS FELT: Ryk frem til et lyseblåt felt. Hvis ingen ejer den får du den gratis ellers\n" +
                   "skal du betale leje til ejeren",/*lyseblåtfelt (iskiosken));
           new GratisFelt("GRATIS FELT: Ryk frem til et orange felt. Hvis ingen ejer den får du den gratis ellers\n" +
